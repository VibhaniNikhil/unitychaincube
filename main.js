$(document).ready(function() {
	...
	function hideSide() {
        ...
        switch(name) {
            case 'laptop':
                window.open('https://www.dell.com', '_blank');
            break;
            case 'ui':
                window.open('https://searchmicroservices.techtarget.com/definition/user-interface-UI', '_blank');
            break;
            case 'speechBubble':
                window.open('https://www.freepik.com/free-photos-vectors/speech-bubble', '_blank');
            break;
            case 'textDocument':
                window.open('https://www.computerhope.com/issues/ch001359.html', '_blank');
            break;
            case 'healthCare':
                window.open('https://www.healthcare.gov/', '_blank');
            break;
            case 'gallery':
                window.open('https://material.io/tools/gallery/', '_blank');
            break;
        }
        
        $('.active').removeClass('active'); 	
		TweenLite.to($cube, 1, {rotationY:0, rotationX: 0, 
